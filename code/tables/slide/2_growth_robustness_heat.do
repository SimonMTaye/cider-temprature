...
use "$data/generated/hi_analysis_twoday.dta", clear
    ...
    local filename "$output/tables/table_growth_robustness_heat_slide.tex"
    ...
    local temp_var heat_index_two_days
    ...
    local sum_row " \\ [-1.7ex] Sum of Heat Index Coefficents& "
    local pval_row ""
