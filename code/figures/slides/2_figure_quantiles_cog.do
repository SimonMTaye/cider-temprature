...
use "$data/generated/hi_analysis_daily.dta", clear 
	...
	* create temperature bins
	...
	reghdfe cognitive_index bin2 bin3 bin4 `lags', absorb(pid day_in_study month#year) cluster(pid)
...
//	
	...
	twoway	(rcap ci_up_2 ci_down_2 x_2, color(emerald)) ///
		...
		xtitle("Temperature Quartiles")  plotregion(margin(right)) 

	graph export "$output/figures/figure_quantiles_cog_slide.pdf", replace
