...
//	
	...
	* new table controlling for lags // no need to display coefficients of lags, just indicate in the table the lags that are being controlled for

	reghdfe m_quality_output temperature_c, absorb(pid day_in_study month#year) cluster(pid)
	
	reghdfe m_quality_output temperature_c l1_temperature_c, absorb(pid day_in_study month#year) cluster(pid)
	
	reghdfe m_quality_output temperature_c l1_temperature_c l2_temperature_c, absorb(pid day_in_study month#year) cluster(pid)
	...
	reghdfe m_quality_output temperature_c l.m_quality_output, absorb(pid day_in_study month#year) cluster(pid)
	
	reghdfe m_quality_output temperature_c l1_temperature_c l.m_quality_output, absorb(pid day_in_study month#year) cluster(pid)
	
	reghdfe m_quality_output temperature_c l1_temperature_c l2_temperature_c l.m_quality_output, absorb(pid day_in_study month#year) cluster(pid)

	reghdfe m_quality_output temperature_c l1_temperature_c l2_temperature_c l3_temperature_c l.m_quality_output, absorb(pid day_in_study month#year) cluster(pid)
