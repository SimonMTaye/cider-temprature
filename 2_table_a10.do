...
****************************************************************
****************************************************************/
// INFO: Table in paper only inclues lag for 1 period (or displays a single period) and not three unlike the one generated by this do file
...
/*
	outreg2 using "$output/tables/table_a10.xls", ///
		addstat("Sum of Coefficients", `coeff_sum', "p-value of Sum", `p_value', "Observations", `num_obs', "R-squared", `r2') ///
